...
This repository contains the source materials (code and data) for the paper *Improving power without increasing sample size: Model-based and design-based strategies for controlling time-dependent nuisance variation in experiments* by Jinghui Liang and Dale J. Barr.
